...
public class DataReader {
    ...
    public static void main(String[] args) {
        ...
        String path = "/Users/is/IdeaProjects/NewFramework/src/data/Books.xlsx";
        List<String> str = dr.getEntireColumnForGivenHeader(path, "Sheet1", "Movies");
        //String str = dr.getValueForGivenHeaderAndKey(path, "Sheet1", "Numbers", "103");
